...
exports.parsed_parameters = function (required_parameters=[],print_missing_parameters=true) {
 ...
 if(!Array.isArray(required_parameters)) {
  console.log("< "+txt['user']+"parsed_parameters"+txt['end']+" "+txt['notify']+"method"+txt['end']+" has an "+txt['error']+"invalid Parameter"+txt['end']+" >");
 ...
 for (var index = 2; index < process.argv.length; index++) {
  if((process.argv[index].charAt(0) == '-') && (process.argv[index].length > 2)) {
   console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"+process.argv[index] + " begins with '-' but is longer than 1 character");
  }
 }
